...
<html lang="en">
  <head>
    <title>FIR sys &mdash; M.P. Police</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="#" class="h2 mb-0">FIR system</a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><button href="#" class="nav-link btn btn-outline-danger">Login</button></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <form action="mail_firdb.php" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  <label class="text-black" for="email">To EmailS</label> 
                  <input type="email" id="email" name="emailsend" class="form-control">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="subject" id="subject" name="mailsubject" class="form-control">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input  id="message" name="message" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here..."></input>
                </div>
              </div>
